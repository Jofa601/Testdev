        ...
        <div class="col-md-12">
          <marquee id="id1">
                ...
                <strong> <a href="#inscription"> <?php echo "Vous êtes le ", $nombre_visiteurs, "ème visiteur sur cette page !"; ?> </em></a></strong>
                  ...
                  <h1 class="title-2">
                    <center><a href="#">DES PHOTOS DE RABAT </a></center>
                  </h1>
        </div>
        <br><br><br><br>
            ...
            <div class="card-overlay">
              <div class="card-header-b">
                <div class="card-title-b">
                  <h2 class="title-2">
                    <a href="blog-single.html">La Vue de Rabat
                      </a>
                  </h2>
                </div>
              </div>
          ...
          <div class="card-box-b card-shadow news-box">
            ...
            <div class="card-overlay">
              <div class="card-header-b">
                <div class="card-title-b">
                  <h2 class="title-2">
                    <a href="blog-single.html">Le centre </a>
                  </h2>
                </div>
              </div>
            </div>
          ...
          <div class="card-box-b card-shadow news-box">
            ...
            <div class="card-overlay">
              <div class="card-header-b">
                <div class="card-title-b">
                  <h2 class="title-2">
                    <a href="blog-single.html"> A Rabat </a>
                  </h2>
                </div>
              </div>
            </div>
          ...
          <div class="card-box-b card-shadow news-box">
            ...
            <div class="card-overlay">
              <div class="card-header-b">
                <div class="card-title-b">
                  <h2 class="title-2">
                    <a href="blog-single.html"> Très jolie </a>
                  </h2>
                </div>
              </div>
            </div>
          ...
          <div class="card-box-b card-shadow news-box">
            ...
            <div class="card-overlay">
              <div class="card-header-b">
                <div class="card-title-b">
                  <h2 class="title-2">
                    <a href="blog-single.html"> Bienvenido </a>
                  </h2>
                </div>
              </div>
            </div>
