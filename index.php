      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="title-wrap d-flex justify-content-between">
            <div class="title-box">
              <h2 class="title-a">About Casablanca</h2>
            </div>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="card-box-c foo">
            ...
            <div class="card-footer-c">
              <a href="casablancadetails.php" class="link-c link-icon">Read more
        ...
        <div class="col-md-6">
          <div class="card-box-c foo">
            ...
            <div class="card-body-c">
              <p class="content-c">
                Casablanca est localisée sur la plaine de la Chaouia, région historiquement agricole et à ce jour l'un des principaux pôles de l'activité agricole du pays. Sa position sur la côte atlantique lui permet l'accès aux ressources maritimes (principalement relatives à la pêche).
              </p>
            </div>
            <div class="card-footer-c">
              <a href="casablancadetails.php" class="link-c link-icon">Read more
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="card-box-b card-shadow news-box">
            <div class="img-box-b">
              <img src="img/c1.jpg" alt="" class="img-b img-fluid">
            </div>
            <div class="card-overlay">
              <div class="card-header-b">
                <div class="card-title-b">
                  <h2 class="title-2">
                    <a href="blog-single.html">Mosquée Casablanca </a>
                  </h2>
                </div>
              </div>
            </div>
        ...
        <div class="col-md-4">
          <div class="card-box-b card-shadow news-box">
            <div class="img-box-b">
              <img src="img/c2.jpg" alt="" class="img-b img-fluid">
            </div>
            <div class="card-overlay">
              <div class="card-header-b">
                <div class="card-title-b">
                  <h2 class="title-2">
                    <a href="blog-single.html">Parc Casablanca
                      </a>
                  </h2>
                </div>
              </div>
        ...
        <div class="col-md-4">
          <div class="card-box-b card-shadow news-box">
            <div class="img-box-b">
              <img src="img/c3.jpg" alt="" class="img-b img-fluid">
            </div>
            <div class="card-overlay">
              <div class="card-header-b">
                <div class="card-title-b">
                  <h2 class="title-2">
                    <a href="blog-single.html">Immeubles Casablanca </a>
                  </h2>
                </div>
              </div>
            </div>
        ...
        <div class="col-md-4">
          <div class="card-box-b card-shadow news-box">
            <div class="img-box-b">
              <img src="img/c4.jpg" alt="" class="img-b img-fluid">
            </div>
            <div class="card-overlay">
              <div class="card-header-b">
                <div class="card-title-b">
                  <h2 class="title-2">
                    <a href="blog-single.html">Cathédrale Casablanca </a>
                  </h2>
                </div>
              </div>
            </div>
        ...
        <div class="col-md-4">
          <div class="card-box-b card-shadow news-box">
            <div class="img-box-b">
              <img src="img/c5.jpg" alt="" class="img-b img-fluid">
            </div>
            <div class="card-overlay">
              <div class="card-header-b">
                <div class="card-title-b">
                  <h2 class="title-2">
                    <a href="blog-single.html">Marina Casablanca </a>
                  </h2>
                </div>
              </div>
            </div>
        ...
        <div class="col-md-4">
          <div class="card-box-b card-shadow news-box">
            <div class="img-box-b">
              <img src="img/c6.jpg" alt="" class="img-b img-fluid">
            </div>
            <div class="card-overlay">
              <div class="card-header-b">
                <div class="card-title-b">
                  <h2 class="title-2">
                    <a href="blog-single.html">Architecture Casablanca </a>
                  </h2>
                </div>
              </div>
            </div>
        ...
        <div class="col-sm-12">
          <div class="contact-map box">
            <div id="map" class="contact-map">
             <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d75214.15418326868!2d-7.673156562804925!3d33.57863773376862!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xda7cd4778aa113b%3A0xb06c1d84f310fd3!2sCasablanca!5e0!3m2!1sfr!2sma!4v1602675144093!5m2!1sfr!2sma" width="1100" height="700" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
            </div>
          </div>
        </div>
